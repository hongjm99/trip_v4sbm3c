...
<c:set var="tripno" value="${param.tripno }" /> <%-- mav.addObject("cateno", contentsVO.getTripno()); // redirect parameter 적용 --%>
    ...
    <UL>
      ...
      <LI class='li_none'>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <button type='button' onclick="location.href='./create.do?tripno=${tripno}'" class="btn btn-secondary btn-sm">새로운 컨텐츠 등록</button>
                <button type='button' onclick="location.href='./list_by_tripno.do?tripno=${tripno}'" class="btn btn-secondary btn-sm">목록</button>
                <button type='button' onclick="location.href='./list_by_tripno_grid.do?tripno=${tripno}'" class="btn btn-secondary btn-sm">갤러리 목록</button>         
            </c:otherwise>
        </c:choose>
