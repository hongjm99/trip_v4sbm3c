...
<c:import url="/menu/top.do" />
  ...
  <table class="table table-striped" style='width: 100%;'>
    ...
    <TR>
      ...
      <TD class='td_left'><A href="./read.do?tripmemberno=${memberno}">${id}</A></TD>
      <TD class='td_left'><A href="./read.do?tripmemberno=${memberno}">${mname}</A></TD>
      ...
      <TD class='td_basic'>
        <A href="./read.do?tripmemberno=${memberno}"><IMG src='/member/images/update.png' title='수정' class="icon"></A>
        <A href="./delete.do?tripmemberno=${memberno}"><IMG src='/member/images/delete.png' title='삭제' class="icon"></A>
      </TD>
