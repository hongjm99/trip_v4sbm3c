          ...
          <ul class="navbar-nav mr-auto">
            ...
            <c:forEach var="tripVO" items="${list_top}">
              ...
              <li class="nav-item"> <%-- 서브 메뉴가 없는 독립메뉴 --%>
                <a class="nav-link top_menu_link" href="/contents/list_by_tripno.do?tripno=${tripVO.tripno }&now_page=1">${tripVO.name }</a> 
              </li>
            </c:forEach>
            ...
            <c:choose>
              ...
              <c:otherwise>
                <li class="nav-item dropdown"> <%-- 관리자 서브 메뉴 --%>
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href='/trip/list_all.do'>카테고리 전체 목록</a>
