...
<form name='frm' method='post' action='/trip/update.do'>
  ...
  <div style="text-align: center;">
    <label>카테고리 이름</label>
    <input type="text" name="name" value="${tripVO.name }" required="required" autofocus="autofocus" 
               class="" style="width: 30%">

    <label>글수</label>
    <input type="text" name="cnt" value="${tripVO.cnt }" required="required" autofocus="autofocus" 
